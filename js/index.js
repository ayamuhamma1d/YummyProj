...
console.log(slideBarInnerWidth);
                    ...
                    <div class="contact-content ">
                        <div class="container text-center ">
                            <div class="row g-4 ">
                                ...
                                <div class="col-md-6 ">
                                    <input id="phoneData" title="Phone" type="tel" class="form-control text-black " placeholder="Enter Your Phone">
...
$("#submitBtn").click(function(){
  let p1=document.getElementById("nameData");
  let p2=document.getElementById("emailData");
  let p3=document.getElementById("phoneData");
  let p4=document.getElementById("ageData");
  let p5=document.getElementById("passwordData");
  let p6 =document.getElementById("rePasswordData");
  p1.value=""
  p2.value=""
  p3.value=""
  p4.value=""
